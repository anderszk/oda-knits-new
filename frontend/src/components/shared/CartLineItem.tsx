...
function RemoveLineButton({ title, onRemove, standalone }: RemoveLineButtonProps) {
  return (
    <button
      type="button"
...
export default function CartLineItem({ line, onDecrease, onIncrease, onRemove, large = false }: CartLineItemProps) {
  return (
