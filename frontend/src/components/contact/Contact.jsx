...
export default function Contact({ info = defaultInfo }) {
  ...
  return (
    <section className="relative grid min-h-[42rem] grid-cols-[.9fr_1fr] items-center gap-16 px-[clamp(1rem,4vw,4rem)] py-20 transition-colors duration-300 max-[900px]:grid-cols-1 max-[900px]:gap-12 max-[620px]:min-h-0 max-[620px]:px-4 max-[620px]:py-14" id="contact" style={{ background: palette.background }}>
      ...
      <motion.form className="relative grid gap-4 rounded-lg border-2 border-ink/10 bg-cream p-8 shadow-[14px_14px_0_var(--palette-shadow)] max-[620px]:p-5 max-[620px]:shadow-[7px_7px_0_var(--palette-shadow)]" style={{ "--palette-shadow": palette.shadow, ...formReveal.style }} onSubmit={submit} ref={formReveal.ref}>
