...
function sphere(parent, mat, scale, position, rotation = [0, 0, 0]) {
...
function eyePatch(parent, mat, scale, position, rotation = [0, 0, 0]) {
...
function flatOval(parent, mat, scale, position, rotation = [0, 0, 0]) {
...
function triangle(parent, mat, scale, position, rotation = [0, 0, 0]) {
