...
const STEPS: { id: "review" | "shipping" | "payment"; label: string }[] = [
...
function ItemList({ items, updateQuantity, removeItem }: ItemListProps) {
  return (
...
function OrderSummaryList({ items }: { items: CartLine[] }) {
  return (
